  ...
  useEffect(() => {
    if (uploadedImage) {
      ...
      img.onload = async () => {
        ...
        else if (renderChoice == 'QR') ctx.drawImage(img, 0, 0, width*15/17, height*15/17);
              ...
              >
                ...
                >
                  ...
                  <Text
                    ...
                    y={(uploadedImagePos[currentPage]?.y || 0) + signatureImageSize.height - signatureImageSize.height*2/20}
                    width={signatureImageSize.width}
                    align={'left'}
                  />
                  <Text
                    ...
                    y={(uploadedImagePos[currentPage]?.y || 0) + signatureImageSize.height - signatureImageSize.height/20}
                    width={signatureImageSize.width}
                    align={'left'}
                  />
                </Group>}
